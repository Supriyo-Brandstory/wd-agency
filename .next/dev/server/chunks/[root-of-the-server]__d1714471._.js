...
async function proxy(request) {
    ...
    if (adminToken) {
        try {
            valid = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwt$2f$verify$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["jwtVerify"](adminToken, new TextEncoder().encode(process.env.JWT_SECRET || 'your-secret-key'));
    ...
    if (request.nextUrl.pathname.startsWith('/admin')) {
        if (!valid && authPaths.includes(request.nextUrl.pathname)) {
            ...
            const response = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/admin', request.url));
