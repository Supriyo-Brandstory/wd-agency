    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (response.ok) {
                ...
                document.cookie = `admin_token=${data.token}; path=/; max-age=${60 * 60 * 24 * 7}; secure=${("TURBOPACK compile-time value", "development") === 'production'}; samesite=strict`;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__45e640af._.js.map