...
const CostCalculator = () => {
  ...
  const getSelectionDetails = () => {
    return categories
      .map(
        (cat) =>
          `${cat.title}: ${pricingData[cat.key][selections[cat.key]].label}`,
      )
      .join("\n");
  };
  ...
  return (
    <>
      <section className="frame-1200 pt-100 sm-pt-0 sm-pb-50 sm-px-20">
        <div className={styles.calculatorContainer}>
          <div className={styles.calcHeader}>
            ...
            <p>
              Every website is unique, and pricing depends on what your business
              needs. Instead of guessing, use our free website cost calculator
              to get a tailored estimate for your project.
            </p>
          </div>
                ...
                >
                  ...
                  <div className={styles.sliderContainer}>
                    ...
                    <input
                      ...
                      value={currentIdx}
                      onChange={(e) =>
                        handleSliderChange(cat.key, e.target.value)
                      }
                  ...
                  <div className={styles.rowValue}>{currentItem.label}</div>
                </motion.div>
              );
            })}
          </div>
          ...
          <div className={styles.summarySticky}>
            ...
            >
              ...
              <p className={styles.disclaimer}>
                * Estimates are based on standard project scope. Contact us for
                a tailored proposal.
              </p>
            </motion.div>
          </div>
      ...
      <QuotePopup
        ...
        modalTitle="Your Cost Calculator Estimate"
        initialData={{
          serviceInterestedIn: "Web Development (Calculator)",
          projectBudget: `${totalMin.toLocaleString()} – ${totalMax.toLocaleString()} AED`,
          projectDetails: `Cost Calculator Selections:\n${getSelectionDetails()}`,
          hideFields: {
            service: true,
            budget: false,
            details: false,
