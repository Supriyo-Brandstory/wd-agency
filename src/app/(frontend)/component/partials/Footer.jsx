        ...
        <div className={styles.container}>
          ...
          <div className={styles.linksWrapper}>
            <div className={styles.about}>
              ...
              <p>
                Established in 2014, Website Development Agency is a leading web
                design and development agency in Dubai, UAE, delivering
            ...
            <div>
              ...
              <ul>
                ...
                <li>
                  <Link href="/travel-web-development">Travel Websites</Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/e-commerce-web-development">
                    E-commerce Websites
                  </Link>
                </li>
                <li>
                  <Link href="/corporate-web-development">
                    Corporate Websites
                  </Link>
                </li>
                <li>
          ...
          <div className={styles.linksWrapper2}>
            <div className={`${styles.contact} mt-20`}>
              ...
              >
                <Image src={mailbox} alt="mailbox" width={30} height={30} />{" "}
              ...
              <Link
                ...
                className="flex gap-x-10 items-center"
              >
                <Image src={call} alt="call" width={30} height={30} /> +971 52
                283 1655
              </Link>
              <Link
            ...
            <div className={styles.cities}>
              <div>
                ...
                <ul>
                  ...
                  <li>
                    <Link href="/website-development-in-abu-dhabi">
                      Abu Dhabi
                    </Link>
                  </li>
                  <li>
                    <Link href="/website-development-in-sharjah">Sharjah</Link>
                  </li>
                  <li>
                    <Link href="/website-development-in-ajman">Ajman</Link>
                  </li>
                  <li>
                    <Link href="/website-development-in-ras-al-khaimah">
                      Ras Al Khaimah
                    </Link>
                  </li>
                </ul>
              ...
              <ul>
                <li>
                  <Link href="/website-development-in-fujairah">Fujairah</Link>
                </li>
                <li>
                  <Link href="/website-development-in-umm-al-quwain">
                    Umm Al Quwain
                  </Link>
                </li>
                <li>
                  <Link href="/website-development-in-al-ain">Al Ain</Link>
                </li>
              </ul>
            </div>
