        ...
        <>
            ...
            <CommonIntroduction
                ...
                text1={` <p>Healthcare in the UAE is rapidly embracing digital transformation. Now that online consultations, patient portals, and scheduling patient appointments have become common, patients expect the highest level of healthcare backed by impeccable digital experience from healthcare providers. Therefore, the need for a professionally made, secure, yet patient-friendly website seems to be less in the category of an extra amenity and more of a mere necessity for small clinics or multi-specialty hospitals.</p>
                    ...
                    `}
                text2={`  <p>This is where WD Agency comes in. Healthcare website design is our forte in the UAE for clinics, hospitals, and medical practices. We build high-quality healthcare websites that put emphasis on user-friendly patient access and communications while ensuring healthcare providers are compliant.</p>
            ...
            <CommonIndustries
                ...
                subheding='At WD Agency, we don’t just build websites, we develop powerful healthcare platforms that enhance patient experiences, streamline operations, and search engine friendly. Our specialized services include:'
                services={[
                    {
