...
const page = () => {
    return (
        <>
            <CommonBanner2
                bg={imagebanner}
                alt="Travel and Tourism Website Development Services in Dubai & The UAE - WD Agency"
            ...
            <CommonIntroduction
                ...
                text1={`<p>The travel and tourism industry in the UAE is rapidly becoming one of the top growth sectors, with millions of international visitors and a powerful local market. Today's travelers depend on digital technology to research, book, and enhance their travel experience. From luxurious vacations, desert excursions, and corporate travel to vacations and weekend escapes, travelers do travel planning, booking, pre-and post-travel engagement to be digitally enhanced.</p>
                    ...
                    `}
                text2={`<p>This is where the WD Agency can help. As a trusted <strong><a href="/">web development agency in Dubai</a></strong>
 & the UAE, we are a leader in travel and tourism website development. We develop websites that offer more than just a pretty site. With travel website solutions we’re providing advanced and seamless booking systems, multilingual, mobile-first experiences, and secure payment gateways with high intention and user engagement in the planning, booking, pre-and post-travel engagement.</p>
                ...
                alt1={'Travel Agency Website Development Services - WD Agency'}
                imageintro2={imageintro2}
                alt2={'Dubai Travel Website Development Services - WD Agency'}
            />
            <CommonWhyMetter
                imagewhymetter={imagewhymetter}
                alt={'Travel Web Design Services in Dubai & The UAE - WD Agency'}
                ...
                services={[
                    {
                        ...
                        img: imageService1,
                        alt: 'Custom Travel Website Design Services - WD Agency',
                        btnname: 'Contact Us',
                        link: '/contact-us',
                    }, {
                        ...
                        img: imageService2,
                        alt: 'Travel Booking and Reservation System Development - WD Agency',
                        btnname: 'Contact Us',
                        link: '/contact-us',
                    },
                    {
                        ...
                        img: imageService3,
                        alt: 'Travel Planner Website Development Services - WD Agency',
                        btnname: 'Contact Us',
                        link: '/contact-us',
                    },
                    {
                        ...
                        img: imageService4,
                        alt: 'Technology Integration Services - WD Agency',
                        btnname: 'Contact Us',
                        link: '/contact-us',
                    },
                    {
                        ...
                        img: imageService5,
                        alt: 'Multi-language Travel Website Development Services - WD Agency',
                        btnname: 'Contact Us',
                        link: '/contact-us',
                    },
                    {
                        ...
                        img: imageService6,
                        alt: 'Mobile-Friendly Travel Website Design - WD Agency',
                        btnname: 'Contact Us',
                        link: '/contact-us',
                    ...
                    },
                    {
                        ...
                        img: imageService7,
                        alt: 'Personalized Travel Recommendation System development - WD Agency',
                        btnname: 'Contact Us',
                        link: '/contact-us',
                    },
                    {
                        ...
                        img: imageService8,
                        alt: 'Travel Website Maintenance and Support Services - WD Agency',
                        btnname: 'Contact Us',
                        link: '/contact-us',
                    }
            ...
            <CommonDevelopmentProcess
                ...
                processData={[
                    ...
                    alt={'Why Choose WD Agency for Travel Website Development - WD Agency'}
